...
const TransactionComponent = ({
  ...
  return (
    <div className='space-y-6'>
      <form onSubmit={(e) => { e.preventDefault(); handleTransaction(); }} className='bg-white p-4 rounded shadow'>
        ...
        <p className='text-sm text-gray-500 mt-2'>Available Balance: {walletInfo.balance} BC</p>
      </form>
      ...
      <div className='bg-white p-4 rounded shadow'>
        ...
        <ul className='space-y-2'>
          ...
          {transactions.length === 0 && <li className='text-gray-500'>No transactions</li>}
        </ul>
      </div>
    </div>
  );
